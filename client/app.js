...
function testcreate()
{
	$("#catent").click(function (e){e.preventDefault();fetch('/api/v1/question/read/'.concat($("#cattex").val()),{method: 'GET'}).then(function(e){return e.json();}).then(function(res){console.log(res.data);});});
}
